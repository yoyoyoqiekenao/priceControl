...
public class ToastUtils {
    ...
    //字体颜色值
    private static final int COLOR_DEFAULT_Te = 0xFFEEEEEE;
    //背景颜色值
    private static final int COLOR_DEFAULT_Bg = 0xD9000000;
    ...
    private static int sBgColor = COLOR_DEFAULT_Bg;
    private static int sBgResource = -1;
    //private static int    sMsgColor    = COLOR_DEFAULT;
    private static int sMsgColor = COLOR_DEFAULT_Te;
        ...
        if (sBgResource != -1) {
            ...
            if (background != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    ...
                    toastView.setBackgroundResource(sBgColor);
                }
            }
        }
    }
